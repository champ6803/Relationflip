...
<div class="modal fade" id="cancelModal" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    <p class="bo_pb">ไม่สามารถติดต่อผู้รับบริการได้ ใช่หรือไม่ ?</p>
                    <button style="text-align: center;" id="btn_cancel_ok" type="button" class="btn btn-success btn-round" data-dismiss="modal">ใช่</button>
                    <button style="text-align: center;" id="cancelsaveBtn" type="button" class="btn btn-warning btn-round" data-dismiss="modal">ไม่</button>
                </div>
            </div>
        </div>
    </div>
