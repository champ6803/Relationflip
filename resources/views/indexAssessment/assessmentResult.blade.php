                    ...
                    <div class="panel-body">
                                ...
                                <div class="row client_details">
                                    <div class="col-md-6">
                                        <div class="form-horizontal">
                                            <div class="row">
                                                <label class="col-md-4">ผู้รับการปรึกษา</label>
                                                <p class="col-md-8" id="client_name">:&nbsp;&nbsp;</p>
                                            </div>
                                        </div>
                                        <div class="form-horizontal">
                                            <div class="row">
                                        ...
                                        <div class="form-horizontal">
                                            <div class="row">
                                                ...
                                                <p class="col-md-8" id="client_code">:&nbsp;&nbsp;</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-horizontal">
                                            <div class="row">
                                                ...
                                                <p class="col-md-8" id="client_position">:&nbsp;&nbsp;</p>
                                            </div>
                                        </div>
                                        <div class="form-horizontal">
                                            <div class="row">
                                                <label class="col-md-4">บริษัท</label>
                                                <p class="col-md-8" id="client_company">:&nbsp;&nbsp;</p>
                                            </div>
                                        </div>
                                        <div class="form-horizontal">
                                            <div class="row">
                                                <label class="col-md-4">E-Mail</label>
                                                <p class="col-md-8" id="client_email">:&nbsp;&nbsp;</p>
                                            </div>
                                        </div>
                                        <div class="form-horizontal">
                                            <div class="row">
                        ...
                        <div class="row aoo_pb">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="inner-title line-top bo_mt">
                                ...
                                <div id="button_action">
                                    ...
                                    <div  class="row eo_pt">
                                        <div class="col-md-12" align="center">
                                            <button id="btn_next" class="btn btn-success btn-lg btn-round">ต่อไป</button>
                                            <button id="btn_info" class="btn btn-success btn-lg btn-round">ดูรายละเอียดการจอง</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="js/assessmentResult.js"></script>
@stop